...
while True:
    ...
    def graph5(month, toggle):
        ...
        fig6.add_trace(go.Indicator(mode='number+delta',
            ...
            title = {"text": f"<span>{gd6['DIA'].iloc[0]} - TOP DIA</span><br><span style='font-size:70%'>Em envio a Boa vista</span><br>"},
    ...
    def graph7(month, toggle):
        ...
        gd7 = gd7.sort_values(by=['ORDEM'],ascending=False)
